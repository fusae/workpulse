...
class ReporterTests(unittest.TestCase):
    ...
    def test_app_summary_marks_multi_category_apps(self):
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            """)
            rows = [
                ("2026-03-31T16:05:00+00:00", "Chrome", "Docs", "浏览", 0, "macos"),
                ("2026-03-31T16:05:30+00:00", "Chrome", "Docs", "浏览", 0, "macos"),
                ("2026-03-31T16:06:00+00:00", "Chrome", "YouTube", "娱乐", 0, "macos"),
                ("2026-03-31T16:06:30+00:00", "Code", "main.py", "编码", 0, "macos"),
            ]
            conn.executemany(
                """
